...
#undef org_kortforsyningen_proj_AuthorityFactory_AXIS
#define org_kortforsyningen_proj_AuthorityFactory_AXIS 7L
#undef org_kortforsyningen_proj_AuthorityFactory_COORDINATE_SYSTEM
#define org_kortforsyningen_proj_AuthorityFactory_COORDINATE_SYSTEM 8L
#undef org_kortforsyningen_proj_AuthorityFactory_CARTESIAN_CS
#define org_kortforsyningen_proj_AuthorityFactory_CARTESIAN_CS 9L
#undef org_kortforsyningen_proj_AuthorityFactory_SPHERICAL_CS
#define org_kortforsyningen_proj_AuthorityFactory_SPHERICAL_CS 10L
#undef org_kortforsyningen_proj_AuthorityFactory_ELLIPSOIDAL_CS
#define org_kortforsyningen_proj_AuthorityFactory_ELLIPSOIDAL_CS 11L
#undef org_kortforsyningen_proj_AuthorityFactory_VERTICAL_CS
#define org_kortforsyningen_proj_AuthorityFactory_VERTICAL_CS 12L
#undef org_kortforsyningen_proj_AuthorityFactory_TEMPORAL_CS
#define org_kortforsyningen_proj_AuthorityFactory_TEMPORAL_CS 13L
#undef org_kortforsyningen_proj_AuthorityFactory_COORDINATE_REFERENCE_SYSTEM
#define org_kortforsyningen_proj_AuthorityFactory_COORDINATE_REFERENCE_SYSTEM 14L
#undef org_kortforsyningen_proj_AuthorityFactory_GEODETIC_CRS
#define org_kortforsyningen_proj_AuthorityFactory_GEODETIC_CRS 15L
#undef org_kortforsyningen_proj_AuthorityFactory_GEOGRAPHIC_CRS
#define org_kortforsyningen_proj_AuthorityFactory_GEOGRAPHIC_CRS 16L
#undef org_kortforsyningen_proj_AuthorityFactory_VERTICAL_CRS
#define org_kortforsyningen_proj_AuthorityFactory_VERTICAL_CRS 17L
#undef org_kortforsyningen_proj_AuthorityFactory_TEMPORAL_CRS
#define org_kortforsyningen_proj_AuthorityFactory_TEMPORAL_CRS 18L
#undef org_kortforsyningen_proj_AuthorityFactory_ENGINEERING_CRS
#define org_kortforsyningen_proj_AuthorityFactory_ENGINEERING_CRS 19L
#undef org_kortforsyningen_proj_AuthorityFactory_PROJECTED_CRS
#define org_kortforsyningen_proj_AuthorityFactory_PROJECTED_CRS 20L
#undef org_kortforsyningen_proj_AuthorityFactory_COMPOUND_CRS
#define org_kortforsyningen_proj_AuthorityFactory_COMPOUND_CRS 21L
#undef org_kortforsyningen_proj_AuthorityFactory_CONVERSION
#define org_kortforsyningen_proj_AuthorityFactory_CONVERSION 22L
#undef org_kortforsyningen_proj_AuthorityFactory_COORDINATE_OPERATION
#define org_kortforsyningen_proj_AuthorityFactory_COORDINATE_OPERATION 23L
/*
