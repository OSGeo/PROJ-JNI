...
#include <jni.h>
/* Header for class org_kortforsyningen_proj_ObjectFactory */

#ifndef _Included_org_kortforsyningen_proj_ObjectFactory
#define _Included_org_kortforsyningen_proj_ObjectFactory
#ifdef __cplusplus
extern "C" {
#endif
 ...
 * Method:    create
 * Signature: ([Ljava/lang/String;[Lorg/kortforsyningen/proj/SharedPointer;[Ljava/lang/String;[DIS)Ljava/lang/Object;
 */
